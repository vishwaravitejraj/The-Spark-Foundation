...
<head>
    ...
    <title>Space Bank for Spark</title>
...
<body>
 ...
 <nav class="navbar navbar-#E75480 bg-white navbar-expand-sm  fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand mr-auto" style="color: #E75480"><i class="fa fa-university" aria-hidden="true">Space Bank for Spark</i></a>
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item "><a class="nav-link" href="index.php" style="color:#E75480"><span class="fa fa-home fa-lg"></span> Home</a></li>
